...
`generate-underdog-duel` 用两张具有严格连续性的电影感图像，讲述“弱者面对强者，却死战不退”的故事：
...
```text
使用 $generate-underdog-duel 生成一组强弱对峙与弱方不屈特写的连续双图。
```

也可以直接描述双方与场景，例如：

```text
使用 $generate-underdog-duel 生成一组麻雀与游隼在暴雨屋顶对峙的连续双图，
